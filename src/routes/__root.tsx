...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Upload, preview and manage your files in a beautifully crafted cloud vault." },
      { name: "author", content: "Vault" },
      { property: "og:title", content: "Vault — Premium File Library" },
